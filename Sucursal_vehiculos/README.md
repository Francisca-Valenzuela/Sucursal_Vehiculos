...
Git Clone: Obtención automática del código fuente mediante Webhook.
Build Application: Compilación y empaquetado del proyecto a formato .war utilizando Maven (mvn clean package).
Creación Imagen Docker: Construcción de la imagen basada en Tomcat copiando el artefacto compilado.
Despliegue Contenedor Tomcat: Despliegue de la aplicación mapeando el puerto 9090 del host al 8080 del contenedor.
